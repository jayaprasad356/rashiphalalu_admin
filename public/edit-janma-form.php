   ...
   if (!empty($title) && !empty($description)&& !empty($nakshatralu)) {
			...
			if ($update_result == 1)
			{
				...
				if (
					...
					$error['update_grahalutab'] = " <section class='content-header'><span class='label label-success'>Janma Nakshathramulu Vati Swabavamulu updated Successfully</span></section>";
			} else {
