   ...
   if (!empty($title) && !empty($description)) {
			...
			if ($update_result == 1)
			{
				...
				if (
					...
					$error['update_grahalutab'] = " <section class='content-header'><span class='label label-success'>Rashulu & Nakshathramulu aantey amiti updated Successfully</span></section>";
			} else {
