...
<section class="content-header">
    <h1>Daily Panchangam /<small><a href="home.php"><i class="fa fa-home"></i> Home</a></small></h1>
    <ol class="breadcrumb">
        <a class="btn btn-block btn-default" href="add-panchangam.php"><i class="fa fa-plus-square"></i> Add Daily Panchangam</a>
    </ol>
</section>
