...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <link rel="icon" type="image/ico" href="dist/img/image.png">
    ...
    <style>
  /* Custom CSS to ensure menu items wrap to the next line */
  .treeview span {
        ...
        <aside class="main-sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <a href="date.php">
                        ...
                        <span>Date,Year,Season & Week</span>
                    </a>
                </li>
                <li class="treeview">
                    <a href="#">
                ...
                <a href="panchangam.php">
                        <i class="fa fa-calendar"></i>
                        <span>Daily panchangam</span>
                    </a>
                </li>
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-calendar"></i>
                        <span>Graha Gocharam</span>
                        <i class="fa fa-angle-right pull-right"></i>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="guru_graham.php"><i class="fa fa-angle-right"></i>Guru Graham</a></li>
                        <li><a href="shani_graham.php"><i class="fa fa-angle-right"></i>Shani Graham</a></li>
                        <li><a href="rahu_ketu_graham.php"><i class="fa fa-angle-right"></i>Rahu Ketu Graham</a></li>
                        <li><a href="nava_grahalu.php"><i class="fa fa-angle-right"></i>Nava Grahalu</a></li>
                    </ul>
                </li>
                <li class="treeview">
                <a href="rashulu.php">
                ...
                <li class="treeview">
                <a href="janma_rashulu.php">
                        <i class="fa fa-calendar"></i>
                        <span> Janma Rashulu Vati Swabhavalu</span>
                    </a>
